...
class RouteServiceProvider extends ServiceProvider
{
    ...
    /**
     * Define the "greencaptain" routes for the application.
     *
     * These routes all receive session state, CSRF protection, etc.
     *
     * @return void
     */
    protected function mapGreencaptainRoutes()
    {
        Route::group([
            'middleware' => ['web', 'greencaptain', 'auth:greencaptain'],
            'prefix' => 'greencaptain',
            'as' => 'greencaptain.',
            'namespace' => $this->namespace,
        ], function ($router) {
            require base_path('routes/greencaptain.php');
        });
    }
